...
export const SettingsPage = () => {
  ...
  return (
    <div className="p-4 sm:p-8">
      <PageHeader eyebrow="Settings" title="Tune your FOODFIT experience" subtitle="Theme, reminders, privacy preferences, and account controls for production deployment." />
